...
export function mapSvg(data: Row[] | unknown, options?: { fill?: string | null; level?: string | null; name?: string | null; key?: string | null; width?: number; height?: number; padding?: number; title?: string | null; subtitle?: string | null; caption?: string | null; labels?: boolean | "name" | "value" | "both"; labelSize?: number; labelColor?: string; labelHalo?: string; legend?: boolean; background?: string; stroke?: string; strokeWidth?: number; missing?: string }): Promise<string>;
