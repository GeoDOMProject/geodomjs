...
export async function interactiveData(data, options = {}) {
  ...
  return { version: '1.3.2', primary: primary.id, layers, options: {
    ...
    stylePreset: options.stylePreset || 'standard', legendCounts: Boolean(options.legendCounts), legendUppercase: Boolean(options.legendUppercase),
